...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { author: @title.author, memo: @title.memo, picture: @title.picture } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { author: @title.author, memo: @title.memo, picture: @title.picture } }
